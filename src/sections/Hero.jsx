...
export default function Hero() {
  return (
    <section className="relative z-10 min-h-[100svh] overflow-hidden font-body">

      <ParticleBackground/>
      
      <div className="relative z-10 w-full max-w-[1200px] min-h-[100svh] mx-auto px-6 md:px-12 lg:px-20 flex items-start md:itemscemter pt-36 md:pt-48">
          ...
          <div className="flex-1">
            ...
            <p className="mt-6 text-[--color-textsub] leading-relaxed max-w-[700px] md:max-w-[750px] text-base md:text-lg">
              ...
              <span className="text-[--color-accent] font-semibold">
                First-Class Computer Engineering graduate
              </span>{" "}
