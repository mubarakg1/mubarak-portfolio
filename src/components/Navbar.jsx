...
export default function Navbar() {
  ...
  return (
    <nav className="fixed top-0 left-0 w-full z-50">
      ...
      <div
        className={`fixed inset-0 bg-[#120F19] flex flex-col items-center justify-center gap-12 text-2xl text-[#E6E6F0] font-display tracking-wide transition-all duration-500
